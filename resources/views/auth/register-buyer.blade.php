...
<div class="register-container">
    ...
    <div class="register-card">
        <div class="card-body">
            ...
            <!-- Registration Form -->
            <form method="POST" action="{{ route('register.buyer') }}" id="registerForm">
                @csrf
...
<script>
    ...
    document.querySelectorAll('.form-control').forEach(input => {
        input.addEventListener('focus', function() {
            this.parentElement.parentElement.querySelector('.form-label').style.color = '#1e3a5f';
            this.parentElement.parentElement.querySelector('.form-label').style.transform = 'translateX(5px)';
        });
        
        input.addEventListener('blur', function() {
            this.parentElement.parentElement.querySelector('.form-label').style.color = '';
