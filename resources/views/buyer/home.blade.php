...
<div class="container my-4">
    <div class="hero-banner mb-4">
        <div class="hero-content">
            ...
            <div class="hero-illustration d-none d-md-block">
                <img src="https://i.postimg.cc/yx8K3Nbg/ecommerce-isometric.jpg" alt="Belanja Mahasiswa" onerror="this.style.display='none';">
            </div>
        </div>
    </div>
    ...
    <div class="category-section">
        <div class="section-header">
            ...
            <div>
                ...
                <div style="display:inline-block;">
                    <button class="btn btn-sm btn-outline-primary me-1 filter-button" data-filter="all" id="filter-all" onclick="filterProducts('all'); return false;">Semua</button>
                    <button class="btn btn-sm btn-outline-primary me-1 filter-button" data-filter="makanan" id="filter-makanan" onclick="filterProducts('makanan'); return false;">Makanan & Minuman</button>
                    <button class="btn btn-sm btn-outline-primary me-1 filter-button" data-filter="jasa" id="filter-jasa" onclick="filterProducts('jasa'); return false;">Jasa</button>
                    <button class="btn btn-sm btn-outline-primary filter-button" data-filter="other" id="filter-lain" onclick="filterProducts('other'); return false;">Lainnya</button>
                </div>
            </div>
        </div>
        ...
        <div class="categories-grid">
            ...
            <a href="#" class="category-card" onclick="filterProducts('jasa'); return false;">
                ...
                <div class="category-name">Jasa Umum</div>
            </a>
            <a href="#" class="category-card" onclick="filterProducts('jasa'); return false;">
                <div class="category-icon">🖨️</div>
                <div class="category-name">Print & Fotocopy</div>
            </a>
            <a href="#" class="category-card" onclick="filterProducts('other'); return false;">
                <div class="category-icon">📚</div>
